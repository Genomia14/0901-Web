...
////		catch문의 경우 예외의 종류를 바꾸면 몇개든 작성할 수 잇음
...
//		} finally {
////		예외가 일어나던 일어나지 않던 무조건 실행할 코드 작성
...
//	0을 나누었을 경우
			...
			System.out.println("InputMismatchException이 발생했습니다.");
		} catch (Exception e) {
//		예외가 발생했을때 실행할 코드를 작성
			System.out.println("예외가 발생했습니다.");
		} finally {
//		예외가 일어단 일어나지 않던 무조건 실행해야하는 코드를 작성
			System.out.println("예외에 상관없이 실행됩니다.");
		}
