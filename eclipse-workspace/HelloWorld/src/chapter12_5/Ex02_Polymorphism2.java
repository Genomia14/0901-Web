...
//	print라는 같은 메서드를 사용함에도
		h1.print(); // 남자 생성을 출력
//		System.out.println(h1.a); a 변수는 부모클래스에 없기 때문에 사용할 수 없음
//		h1.a(); 부모클래스에 없는 메서드를 사용할 수 없음
		Human h2 = humanCreate(2);
		h2.print(); // 여자 생성을 출력
//		System.out.println(h2.b); b 변수는 부모클래스에 없기 때문에 사용할 수 없음
//		h2.b(); 부모클래스에 없는 메서드를 사용할 수 없음
	}
}
