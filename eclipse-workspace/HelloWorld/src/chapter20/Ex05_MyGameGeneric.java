...
// }
class Camp5<T> {
// 제네릭으로 설정한 T는 멤버 변수, 메서드, 생성자에서 자료형으로 사용 가
	private T unit;
...
//	Camp<int> intTest = new Camp5<>(); int는 기본자료형이기 때문에 에러 발생
//	숫자를 사용하려면 int대신 Intege를 사용하자
		Camp5<Integer> intgerTest = new Camp5<>();

//	Camp5<Npc5>로 설정했기 때문에 Npc5만 저장할 수 있도록 변경
		human.set(new Npc5());
