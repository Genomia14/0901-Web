...
public class EX01_var {
	...
	public static void main(String[] args) {
		...
		// 언더스코어표기법(상수) : STRING_VALUE, MAX_COUNT, MINCOUNT
		// 변수의 작성 방법
		// 1. 카멜표기법, 변수의 첫단어의 첫글자는 소문자로 나머지 
		//	  단어의 첫글자는 대문자로 작성
		...
		// 3번
		String StringValue = "오늘의 낡씨는 맑음";
		System.out.println(StringValue);
		
		// 4번
		double daubleValue = 3.14;
		System.out.println(daubleValue);
