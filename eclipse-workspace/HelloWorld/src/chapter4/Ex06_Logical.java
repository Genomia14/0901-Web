...
public class Ex06_Logical {
	...
	public static void main(String[] args) {
		...
		// || (Or연산자) : true || true = true, true || false = true
		// 		     	  false || false = false
		System.out.println("true || true " + (true || true));
		System.out.println("true || false " + (true || false));
		System.out.println("false || true " + (false || true));
		...
		// 우산 가져가기 : 비가 오거나 눈이 올 때 우산을 가져가야 함
		...
		// 시험 합격 조건(Or연산자)
		// 국어, 수학, 영어 중 90점이 넘는 과목이 있다면 합격입니다.
		int 국어 = 95;
		int 수학 = 80;
		int 영어 = 70;
		System.out.println("합격 : " + (국어 >= 90 || 수학 >= 90 || 영어 >= 70));
		...
		boolean 비행기표 = false;
		int 현재시간 = 7;
		System.out.println("탑승 가능 유무 : " + (여권 && 비행기표 && 현재시간 < 9));
		System.out.println("탑승 가능 유무 : " + (여권 && !(비행기표) && 현재시간 < 9));
