...
//		IF문
		Scanner sc = new Scanner(System.in);
		System.out.println("IF문 몇일인지 입력해주세요.");
		int day = sc.nextInt();
		// 0~9 / 10 = 0
		// 10~19 / 10 = 1
		// 20~29 / 10 = 2
		...
		switch(month) {
			...
			case 4: case 6: case 9: case 11:
				...
				break;		
			case 2:
				System.out.println(month + "월 29일, 윤년인 경우 28일 입니다");
				break;		
			default:
				System.out.println(month + "월 1~12 사이의 월을 입력해주세요.");
		}
