...
class Rect {
// 가로, 세로 크기를 저장하는 멤버 변수 두개를 선언
	private int width, height;

// 가로, 세로 크기를 반드시 설정하여 Rect 클래스를 생성하도록 하는 생성자
	public Rect(int width, int height) {
		this.width = width;
		this.height = height;
	}

// 가로, 세로 크기를 곱하여 넓이를 구하는 getArea 메서드
	public int getArea() {
		return width * height;
	}
// getter, setter가 없기 때문에 Rect 클래스에서
// 가로, 세로 크기를 출력하거나 변경하는 것은 불가능
}
