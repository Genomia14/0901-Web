			...
			<div class="bodytext_area box_inner">
				...
				<form action="loginProcess.jsp" method="post">
					<div class="login_wrap">
						<h1 class="loginTit">
							<a href="Index.jsp"><img src="img/tit_login.png"
								alt="TOURIST IN TOUR" /></a>
						</h1>
						<ul class="login_list">
						...
						String loginErr = request.getParameter("loginErr");
							...
							<li>
							<li><input type="checkbox" class = "css-checkbox" name="save_check" value="Y" <%=loginId.equals("") ? "" : checkd%> />
								<label for="agree_lbl">아이디저장</label>
