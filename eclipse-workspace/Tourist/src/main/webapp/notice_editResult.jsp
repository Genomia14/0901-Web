...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">	
			<form name="writeFrm" action="notice_edit_process.jsp"
			 method="post" onsubmit="return validateForm(this);">		
			<input type="hidden" name="num" value="${num}"/>
			<ul class="bbsview_list">
					<li class="bbs_title">제목 : <input type="text" name="title" size="100" value="${dto.title}" placeholder="제목을 입력해주세요."></li>
			...
			<p class="btn_line txt_right">
				...
				<button type="button" class="btn_srch" onclick="location.href='notice_list.jsp';">목록</button>
			</p>
			</form>
...
<jsp:include page="quicklink.jsp"></jsp:include>
