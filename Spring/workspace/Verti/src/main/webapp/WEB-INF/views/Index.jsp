					...
					<div class="col-4 col-12-medium">
						...
						<section class="box feature">
							<a href="Beans.jsp" class="image featured"><img
								src="<%=request.getContextPath()%>/resources/images/Beans.jpg"
					...
					<div class="col-4 col-12-medium">
						...
						<section class="box feature">
							<a href="Coffee.jsp" class="image featured"><img
                                    src="/resources/images/cof_1.jpg" style="height: 300px; object-fit: cover;" /></a>
							<div class="inner">
								<header>
					...
					<div class="col-4 col-12-medium">
						...
						<section class="box feature">
							<a href="Dessert.jsp" class="image featured"><img
								src="/resources/images/Dessert.jpg"
								style="height: 300px; object-fit: cover;" /></a>
							<div class="inner">
								<header>
									...
									<div class="row gtr-50">
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/Caffe%20Latte.png" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/cafe_inside.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/Beans_make.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/dessert_1.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/bari.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img
                                                    src="/resources/images/bean.png" alt="" /></a>
										</div>
									</div>
								</div>
							</section>
